...
class Kasse : AppCompatActivity(),  GoodsCatch {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        goodsCatch =
            Mvp(this, namekaufgoodk!!, pricegoodskaufk!!, countkaufk!!, namegoodk!!, this, countk!!)
        var inte: Intent
 ...
 */
    ...
    override fun fullTable(list: List<SaveGoodsDB.Goodssache>) {
        listgoodssave.clear()
        for (good in list) {
    ...
    override fun addElement() {
        goodsCatch!!.addElement(
            SaveGoodsDB.Goodssache(
                namekaufgoodk!!.text.toString(), pricegoodskaufk!!.text.toString()
